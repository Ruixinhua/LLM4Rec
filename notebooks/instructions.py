...
${candidate}
# Output Format
The output should be in the format: "The top 10 recommended news headlines, ranked solely by relevance to the user's interests: <START>C#, C#, C#, C#, C#, C#, C#, C#, C#, C#<END>".
"""
...
Use "${history}" as the placeholder for the "User's History News" and "${candidate}" as the placeholder for the "Candidate News"."""
